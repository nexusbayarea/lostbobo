...
- **SYSTEM.md** - Source of Truth (ports, folders, AI guardrails)
- **DEPLOYMENT.md** - SOP for RunPod, Vercel, Infisical
- **MISSION_CONTROL_STRATEGY.md** - Product logic (O-D-I-A-V)
- **CHANGELOG.md** - Version history

Deleted: GEMINI.md, GUIDE.md, ALPHA_PILOT_GUIDE.md, COMPREHENSIVE_AUDIT.md (merged into SYSTEM.md)

---

## Current Status

- **v2.6.7**: Dual-port strategy (8080 primary, 8000 backup) + Async Integrity + Authority Alignment
- **v2.6.27**: **Authority Alignment** (Supabase as absolute source of truth for usage)
