        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link
                to="/signup"
                className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-white bg-slate-900 dark:bg-background dark:text-slate-900 rounded-xl hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors"
              >
                Get Started
              </Link>
            </div>
              ...
              <nav className="flex flex-col p-4 space-y-2">
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-slate-800 space-y-2">
                  ...
                  <Link
                    to="/signup"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="block px-4 py-3 text-base font-medium text-white bg-slate-900 dark:bg-background dark:text-slate-900 rounded-xl text-center"
                  >
                    Get Started
                  </Link>
                </div>
